...
Try {
	...
	[string]$appScriptDate = '10/16/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## <Perform Installation tasks here>
		   ...
		   If (Test-Path "C:\Cache\pc-client.exe*") {
			 ...
			 Copy-File -Path "$dirFiles\PaperCut" -Destination "$envProgramFiles" -Recurse
			 Set-RegistryKey -Key 'HKLM\Software\Microsoft\Windows\CurrentVersion\Run' -Name 'PaperCut' -Value '"C:\Program Files\PaperCut\pc-client.exe"' -Type STRING
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		# <Perform Uninstallation tasks here>
			 ...
			 #Check if PaperCut currently running
		   ...
		   If (Test-Path "C:\Program Files\PaperCut") {
				   Remove-File -Path "C:\Program Files\PaperCut" -Recurse
		   }
